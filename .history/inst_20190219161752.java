...
public class inst {
    ...
    */
    ...
    private void write_back() {
        System.out.println(Globals.pipelineList[4]);
    }

    private void memory() {
        // access the memory locations if needed
        System.out.println(Globals.pipelineList[3]);
    }

    private void execute() {
        System.out.println(Globals.pipelineList[2]);
    }

    private void decode() {
        System.out.println(Globals.pipelineList[1]);
    }

    private void fetch() {
        // get the opcode for the instruction
        // store it in the linked list
        System.out.println(Globals.pipelineList[0]);
    }
